...
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "7351312658:AAFC_KwpLnYX4FB0sa-dwnszrcbtBUwam5E")
...
#Your db channel Id
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002213510928"))

# NAMA OWNER
OWNER = os.environ.get("OWNER", "Roronoa Zoro")
...
DB_NAME = os.environ.get("DATABASE_NAME", "DkNabeel")
...
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @AAnimeOngoing </b>")
